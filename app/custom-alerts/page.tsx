...
const CustomAlertsPage = () => {
  ...
  const [rules, setRules] = useState([
    { field: "subject", condition: "contains", value: "Cerberus", logic: "and" },
    { field: "email_domain", condition: "is_not", value: "zenith.com", logic: "and" },
  ]);

  // Placeholder for adding/removing rules
  const addRule = () => setRules([...rules, { field: "subject", condition: "contains", value: "", logic: "and" }]);
